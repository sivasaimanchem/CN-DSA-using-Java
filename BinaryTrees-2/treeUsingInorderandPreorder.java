...
public class treeUsingInorderandPreorder {
    public static void main(String[] args) {
        ...
        BTNode<Integer> root=op.constructTree(inorder,preorder);
        op.display(root);
...
class operations {
    ...
    BTNode<Integer> constructTree(int[] inorder, int[] preorder){
        BTNode<Integer> root=constructTreehelper(inorder, preorder,0,inorder.length-1,0,preorder.length-1);
        return root;
    }
    BTNode<Integer> constructTreehelper(int[] inorder, int[] preorder,int is,int ie,int ps,int pe){
        ...
        BTNode<Integer> left=constructTreehelper(inorder, preorder, sili, eili, silp, eilp);
        BTNode<Integer> right=constructTreehelper(inorder, preorder, siri, eiri, sirp, eirp);
